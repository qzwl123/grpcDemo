...
const ::_pbi::TcParseTable<2, 4, 0, 0, 2> Person::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
    ...
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(Person, _impl_.age_), 63>(),
     {32, 63, 0, PROTOBUF_FIELD_OFFSET(Person, _impl_.age_)}},
    // int32 id = 1;
    ...
    // bytes sex = 3;
    {::_pbi::TcParser::FastBS1,
     {26, 63, 0, PROTOBUF_FIELD_OFFSET(Person, _impl_.sex_)}},
  }}, {{
    65535, 65535
  }}, {{
    // int32 id = 1;
    ...
    // bytes sex = 3;
    {PROTOBUF_FIELD_OFFSET(Person, _impl_.sex_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kBytes | ::_fl::kRepAString)},
    // int32 age = 4;
