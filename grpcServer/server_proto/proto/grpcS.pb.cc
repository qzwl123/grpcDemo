...
static ::_pb::Metadata file_level_metadata_grpcS_2eproto[2];
static constexpr const ::_pb::EnumDescriptor**
    file_level_enum_descriptors_grpcS_2eproto = nullptr;
static constexpr const ::_pb::ServiceDescriptor**
    file_level_service_descriptors_grpcS_2eproto = nullptr;
const ::uint32_t
    TableStruct_grpcS_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        ~0u,  // no _has_bits_
        ...
        PROTOBUF_FIELD_OFFSET(::Request, _impl_.sex_),
...
static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        ...
        {12, -1, -1, sizeof(::Response)},
};
static const ::_pb::Message* const file_default_instances[] = {
    &::_Request_default_instance_._instance,
    &::_Response_default_instance_._instance,
};
const char descriptor_table_protodef_grpcS_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n\013grpcS.proto\"=\n\007Request\022\n\n\002id\030\001 \001(\005\022\014\n\004"
    "name\030\002 \001(\014\022\013\n\003sex\030\003 \001(\014\022\013\n\003age\030\004 \001(\005\"\033\n\010"
    "Response\022\017\n\007message\030\001 \001(\t2*\n\005grpcS\022!\n\010sa"
    "yHello\022\010.Request\032\t.Response\"\000b\006proto3"
};
static ::absl::once_flag descriptor_table_grpcS_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_grpcS_2eproto = {
    false,
    false,
    157,
    descriptor_table_protodef_grpcS_2eproto,
    "grpcS.proto",
    &descriptor_table_grpcS_2eproto_once,
    nullptr,
    0,
    2,
    schemas,
    file_default_instances,
    TableStruct_grpcS_2eproto::offsets,
    file_level_metadata_grpcS_2eproto,
    file_level_enum_descriptors_grpcS_2eproto,
    file_level_service_descriptors_grpcS_2eproto,
};
...
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_grpcS_2eproto_getter() {
  return &descriptor_table_grpcS_2eproto;
}
// ===================================================================
...
const ::_pbi::TcParseTable<2, 4, 0, 0, 2> Request::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
    ...
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(Request, _impl_.age_), 63>(),
     {32, 63, 0, PROTOBUF_FIELD_OFFSET(Request, _impl_.age_)}},
    // int32 id = 1;
    ...
    // bytes sex = 3;
    {::_pbi::TcParser::FastBS1,
     {26, 63, 0, PROTOBUF_FIELD_OFFSET(Request, _impl_.sex_)}},
  }}, {{
    65535, 65535
  }}, {{
    // int32 id = 1;
    ...
    // bytes sex = 3;
    {PROTOBUF_FIELD_OFFSET(Request, _impl_.sex_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kBytes | ::_fl::kRepAString)},
    // int32 age = 4;
...
::uint8_t* Request::_InternalSerialize(
  ...
  if (!this->_internal_sex().empty()) {
    const std::string& _s = this->_internal_sex();
...
::google::protobuf::Metadata Request::GetMetadata() const {
  return ::_pbi::AssignDescriptors(&descriptor_table_grpcS_2eproto_getter,
                                   &descriptor_table_grpcS_2eproto_once,
                                   file_level_metadata_grpcS_2eproto[0]);
}
// ===================================================================
...
::google::protobuf::Metadata Response::GetMetadata() const {
  return ::_pbi::AssignDescriptors(&descriptor_table_grpcS_2eproto_getter,
                                   &descriptor_table_grpcS_2eproto_once,
                                   file_level_metadata_grpcS_2eproto[1]);
}
...
static ::std::false_type _static_init_ PROTOBUF_UNUSED =
    (::_pbi::AddDescriptors(&descriptor_table_grpcS_2eproto),
     ::std::false_type{});
