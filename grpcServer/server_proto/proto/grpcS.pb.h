...
#ifndef GOOGLE_PROTOBUF_INCLUDED_grpcS_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_grpcS_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_grpcS_2eproto
...
struct TableStruct_grpcS_2eproto {
  static const ::uint32_t offsets[];
};
extern const ::google::protobuf::internal::DescriptorTable
    descriptor_table_grpcS_2eproto;
class Request;
...
/* @@protoc_insertion_point(class_definition:Response) */ {
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_grpcS_2eproto;
};
// -------------------------------------------------------------------
...
// bytes sex = 3;
inline void Request::clear_sex() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_.sex_.ClearToEmpty();
}
inline const std::string& Request::sex() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:Request.sex)
  return _internal_sex();
}
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void Request::set_sex(Arg_&& arg,
                                                     Args_... args) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_.sex_.SetBytes(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:Request.sex)
}
inline std::string* Request::mutable_sex() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_sex();
  // @@protoc_insertion_point(field_mutable:Request.sex)
  return _s;
}
inline const std::string& Request::_internal_sex() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return _impl_.sex_.Get();
}
inline void Request::_internal_set_sex(const std::string& value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  _impl_.sex_.Set(value, GetArena());
}
inline std::string* Request::_internal_mutable_sex() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  return _impl_.sex_.Mutable( GetArena());
}
inline std::string* Request::release_sex() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  // @@protoc_insertion_point(field_release:Request.sex)
  return _impl_.sex_.Release();
}
inline void Request::set_allocated_sex(std::string* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ...
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:Request.sex)
}
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_grpcS_2eproto_2epb_2eh
